...
%{ if (lang == "jvm") }
      options <- return $ JVMCompilerConfiguration { jvmLibLocation = "../../..", jvmBinLocation = "../../..", jvmRunProgram = True }
%{ endif }
%{ if (lang == "llvm") }
      options <- return $ LLVMCompilerConfiguration { llvmLibLocation = "../../..", llvmRunProgram = True }
%{ endif }
